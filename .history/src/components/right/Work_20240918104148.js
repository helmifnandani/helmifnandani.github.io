    ...
    <section ref={ref} className="mb-16" id="work">
      ...
      <Card>
        ...
        <p className="font-light leading-7 mb-4">
          I implement responsive website and web applications as a Front End
        ...
        <p className="font-light leading-7">
          Contributed in revamp UI/UX of the company website. Contributed in
          revamp UI/UX of the WebApp into modern view. Contributed in
          development of Livin Mandiri commerce
        </p>
      </Card>
