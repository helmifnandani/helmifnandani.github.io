  ...
  return (
    <div className="mb-6 sticky top-[7rem] mt-12 lg:mt-0">
      ...
      <p className="font-light leading-7">
        ...
        well-organized person, committed and eager to learn individual who has
        couple years of experience implementing responsive design into websites.
        Wish to join a development team in a dynamic, ambitious company and
        forge a career in IT industry.
      </p>
